...
class EditProduct extends React.Component {
    ...
    loadProduct = async () => {
        ...
        try {
            let response = await fetch("https://api-curnon-springbooot.herokuapp.com/api/admin/product/"+this.state.id, requestOptions)
            if (response.ok) {
                let result = await response.json()
    ...
    render() {
        return <>
            ...
            <div className="field item form-group">
                ...
                <div className="col-md-6 col-sm-6">
                    <img style={{ width: "80px" }} src={"https://api-curnon-springbooot.herokuapp.com/api/download/"+this.state.image} />
