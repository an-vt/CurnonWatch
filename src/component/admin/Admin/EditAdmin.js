...
class EditAdmin extends React.Component {
    ...
    loadAccountAdmin = async () => {
        ...
        try {
            let response = await fetch("https://api-curnon-springbooot.herokuapp.com/api/admin/account/"+this.state.id, requestOptions)
    ...
    editProduct = async () => {
        ...
        formdata.append("role", "ROLE_ADMIN");
    ...
    render() {
        return <>
            ...
            <div className="field item form-group">
                ...
                <div className="col-md-6 col-sm-6">
                    <img style={{ width: "80px" }} src={"https://api-curnon-springbooot.herokuapp.com/api/download/"+this.state.avatar} />
