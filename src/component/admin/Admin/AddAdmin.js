...
class AddAdmin extends React.Component {
    ...
    AddAdmin = async () => {
        ...
        try {
            let response = await fetch("https://api-curnon-springbooot.herokuapp.com/api/admin/account", requestOptions)
            if(response.ok) {
        ...
        // await fetch("https://api-curnon-springbooot.herokuapp.com/api/admin/account", requestOptions)
        //     .then(response => {
        //         if (response.ok) {
